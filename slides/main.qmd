...
# Module 5: Cleaning and Transforming Data for Analysis
(~30 minutes)

## Introduction to Data Cleaning and Transformation
- Data cleaning and transformation are essential steps in preparing data for analysis
- Raw data from APIs often contains inconsistencies, missing values, and irrelevant information
- The goal is to transform the data into a clean, structured format that can be easily analyzed
...
- Using the data fetched from the UK House of Commons API, perform the following tasks:
  - Clean the dataset by removing any duplicates and handling missing values
  - Standardize the format of dates and other relevant fields
  - Rename columns for clarity and consistency
  - Filter the dataset to include only relevant information for your analysis
- Document your cleaning and transformation steps in the notebook
